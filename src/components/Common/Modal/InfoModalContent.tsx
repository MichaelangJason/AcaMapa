...
import { useEffect, useState, useRef, useMemo, type JSX } from "react";
...
import type { InfoModalProps, CommonModalProps } from "@/types/modals";
...
// TODO
const InfoModalContent = ({ closeCb }: InfoModalProps & CommonModalProps) => {
  ...
  return (
    <>
      <button className="close-button" onClick={closeCb}>
        <DeleteIcon />
      </button>
